# Note: Originally downloaded from RTAB-map (https://github.com/introlab/rtabmap)
#
######################################################################
#
# Hacked to work with the SDK, but does not work for the general case.
#
######################################################################
#
...
find_path(RealSenseSdk_INCLUDE_DIRS NAMES rs_sdk.h PATHS $ENV{RealSense_ROOT_DIR}/include)
...
if(CMAKE_CL_64)
	...
	find_library(RealSensePlayback_LIBRARY NAMES realsense_playback PATHS $ENV{RealSense_ROOT_DIR}/lib  $ENV{RealSense_ROOT_DIR}/bin $ENV{RealSense_ROOT_DIR}/bin/x64)
else()
	...
	find_library(RealSensePlayback_LIBRARY NAMES realsense_playback PATHS $ENV{RealSense_ROOT_DIR}/lib  $ENV{RealSense_ROOT_DIR}/bin $ENV{RealSense_ROOT_DIR}/bin/Win32)
endif()
...
IF (RealSense_FOUND)
	...
	IF(RealSenseSdk_INCLUDE_DIRS)
		SET(RealSenseSdk_FOUND TRUE)
	ENDIF(RealSenseSdk_INCLUDE_DIRS)
	...
	SET(RealSense_LIBRARIES 
		...
		${RealSensePlayback_LIBRARY})

	SET(RealSense_INCLUDE_DIRS
		${RealSense_INCLUDE_DIRS}
		${RealSenseSlam_INCLUDE_DIRS}
		${RealSenseSdk_INCLUDE_DIRS})

	# show which RealSense was found only if not quiet
	IF (NOT RealSense_FIND_QUIETLY)
		MESSAGE(STATUS "Found RealSense: ${RealSense_INCLUDE_DIRS} ${RealSense_LIBRARIES}")
